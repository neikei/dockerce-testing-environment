...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
      ...
      vb.customize ["modifyvm", :id, "--name", "dockerce-testing-environment"]
  end
  ...
  config.hostmanager.aliases = 'portainer.test'
  config.vm.hostname = 'dockerce-testing-environment'
  ...
  # Post-up message
  config.vm.post_up_message = "See https://github.com/neikei/dockerce-testing-environment for help and bug reports."
